...
class Header extends React.Component {
    ...
    render() {
        ...
        if (process.env.BROWSER && route.page !== 'Post') document.title = page_title + ' — MapalaNet';
                    ...
                    <div className="expanded row">
                        <div className="columns">
                            <ul className="menu">
                                ...
                                <li className="Header__top-steemit show-for-medium"><Link to={logo_link}>MapalaNet<span className="beta">beta</span></Link></li>
