...
class Topics extends React.Component {
    ...
    render() {
        ...
        if (compact) {
           ...
           location.replace('/trending/i_am_mapala');
        
     //   categories = categories.filter(val => val.indexOf("life") !== -1);
        categories = ["i_am_mapala", "city_overview", "life_hack", "must_see", "events", "stories", "mapala_tv"];
        ...
        return (
            <ul className={cn}>
               ...
               {!expanded && !search && <li className="show-more">
                  ...
                  {/* <Link to={`/tags.html/${order}`}>Show payments..</Link>*/}
               </li>}
            </ul>
        );
    }
